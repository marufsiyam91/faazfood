  ...
  return (
    <div className="max-w-screen-2xl mx-auto py-20">
      <div className="flex flex-col gap-6 justify-center text-center">
        <p className="text-red-700 text-xl font-semibold">WHY CHOOSE FASFOOD?</p>
        <h2 className="text-slate-800 text-4xl md:text-5xl 2xl:text-7xl font-bold">BURGERS MADE WITH <br /> LOVE AND CARE</h2>
      </div>

        <div className="flex md:flex-row gap-4 flex-col px-6 lg:px-8 2xl:px-16 pt-12">
          <div>
